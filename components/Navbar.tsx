...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full  border-border/40 bg-muted/20 backdrop-blur-md">
      <div className="px-4 md:px-6  h-16 lg:h-18 flex items-center justify-between ">
