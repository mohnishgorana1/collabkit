      ...
      <form onSubmit={handleCreate} className="space-y-5 text-left">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <input type="text" id="name" name="name" required placeholder="e.g. Acme Corp" className={inputStyles} />
          </div>
          <div className="space-y-1.5">
            ...
            <select id="companySize" name="companySize" required className={`${inputStyles} appearance-none`}>
